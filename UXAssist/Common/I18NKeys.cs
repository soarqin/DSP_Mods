...
public static class I18NKeys
{
    ...
    public const string StopAutoCruiseOnManualInput = "Stop auto-cruise on manual input";
...
""");
        ...
        I18N.Add(StopAutoCruiseOnManualInput, "Stop auto-cruise on manual input", "手动输入时停止自动巡航");
